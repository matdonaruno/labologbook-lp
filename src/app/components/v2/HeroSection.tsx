...
export const HeroSection: React.FC<HeroSectionProps> = ({ onLogin }) => {
  ...
  return (
    <section ref={containerRef} className="relative h-[120vh] flex flex-col items-center justify-center overflow-hidden bg-[#050508]">
      ...
      {/* 2. Content */}
      <div className="relative z-30 container mx-auto px-6 h-screen flex flex-col justify-center items-center text-center">
        ...
        <motion.h1
            style={{ y: textY }}
            className="text-[12vw] leading-[0.85] font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-white/30 mb-6 select-none"
        >
        ...
        <motion.h2
            ...
            className="text-xl md:text-2xl lg:text-3xl font-bold text-white mb-6 tracking-tight leading-[1.2]"
        >
            検査室の「すべて」を、<span className="text-purple-400" style={{ textShadow: '0 0 20px rgba(147,51,234,0.8), 0 0 40px rgba(147,51,234,0.5)' }}>これ１つで。</span>
        </motion.h2>
        ...
        <motion.p
            ...
            className="text-white text-lg md:text-xl max-w-2xl mx-auto mb-5 font-light tracking-wide leading-relaxed"
            style={{ textShadow: '0 2px 4px rgba(0,0,0,0.8), 0 4px 12px rgba(0,0,0,0.5)' }}
        >
            温度管理、精度管理、機器メンテナンス、AIアシスタント。<br />
        ...
        >
            ...
            >
                ...
                <span className="font-medium tracking-wide">お問い合わせ</span>
            </a>
        </motion.div>
